...
class PipeNetwork:
    ...
    def highest_flow(self, T): # T is the max time
        ...
        while len(q) > 0:
            ...
            for next_valve in self.useful_valves.difference(current_open | {current_valve}):
                dist = self.spg[(current_valve, next_valve)] + 1
                next_open
